...
namespace WineryApp.Migrations
{
    ...
    [Migration("20190521095420_Nullable podrumId u povijestAditiva")]
    partial class NullablepodrumIdupovijestAditiva
    {
            ...
            modelBuilder.Entity("WineryApp.Data.Entiteti.KategorijaZadatka", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            KategorijaZadatkaId = 13,
                            ImeKategorije = "Uzorak za analizu"
                        });
                });
            ...
            modelBuilder.Entity("WineryApp.Data.Entiteti.PovijestSpremnika", b =>
                {
                    ...
                    b.Property<string>("KategorijaZadatka")
                        .HasMaxLength(50)
                        .IsUnicode(false);
            ...
            modelBuilder.Entity("WineryApp.Data.Entiteti.VrstaAditiva", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            VrstaAditivaId = 2,
                            NazivVrste = "Konzervans"
                        },
                        new
                        {
                            VrstaAditivaId = 3,
                            NazivVrste = "Regulator kiselosti"
                        },
                        new
                        {
                            VrstaAditivaId = 4,
                            NazivVrste = "Potisni plin"
                        },
                        new
                        {
                            VrstaAditivaId = 5,
                            NazivVrste = "Antioksidans"
                        },
                        new
                        {
                            VrstaAditivaId = 6,
                            NazivVrste = "Emulgator"
                        },
                        new
                        {
                            VrstaAditivaId = 7,
                            NazivVrste = "Stabilizator"
                        },
                        new
                        {
                            VrstaAditivaId = 8,
                            NazivVrste = "Zgušnjivač"
                        },
                        new
                        {
                            VrstaAditivaId = 9,
                            NazivVrste = "Tvar za zaslađivanje"
                        },
                        new
                        {
                            VrstaAditivaId = 10,
                        ...
                        {
                            VrstaAditivaId = 11,
                            NazivVrste = "Tvar za želiranje"
                        },
                        new
                        {
                            VrstaAditivaId = 12,
                            NazivVrste = "Učvršćivač"
                        },
                        new
                        {
                            VrstaAditivaId = 13,
                            NazivVrste = "Tvar za sprečavanje zgrudnjavanja"
                        },
                        new
                        {
                            VrstaAditivaId = 14,
                            NazivVrste = "Pojačivač okusa/arome"
                        },
                        new
                        {
                            VrstaAditivaId = 15,
